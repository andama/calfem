...
#cfvv.draw_geometry(edof,coord,dof,1,alpha=0.3)
...
#cfvv.draw_displaced_geometry(edof,coord,dof,a,N,1,label='Normal force',def_scale=5,nseg=nseg)
#cfvv.draw_displaced_geometry(edof,coord,dof,a,T,1,label='Torque',def_scale=5,nseg=nseg)
